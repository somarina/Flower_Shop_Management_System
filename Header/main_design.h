...
//no animation
	...
	// H::setcolor(6); H::gotoxy(29,21);cout << R"(     ______   _____)";
	// H::setcolor(6); H::gotoxy(29,22);cout << R"(    / ____/  / ___/)";
	// H::setcolor(6); H::gotoxy(29,23);cout << R"(   / /_      \__ \ )";
	// H::setcolor(6); H::gotoxy(29,24);cout << R"(  / __/     ___/ / )";
	// H::setcolor(6); H::gotoxy(29,25);cout << R"( /_/       /____/  )";

	// H::setcolor(6); H::gotoxy(135,21);cout << R"(     __  ___   _____)";
	// H::setcolor(6); H::gotoxy(135,22);cout << R"(    /  |/  /  / ___/)";
	// H::setcolor(6); H::gotoxy(135,23);cout << R"(   / /|_/ /   \__ \ )";
	// H::setcolor(6); H::gotoxy(135,24);cout << R"(  / /  / /   ___/ / )";
	// H::setcolor(6); H::gotoxy(135,25);cout << R"( /_/  /_/   /____/ )";
