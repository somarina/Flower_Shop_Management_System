...
// 			if(x==1)
// 			{
// 				H::drawBoxSingleLine(33,12,23,3,130);
// 				H::setcolor(228); H::gotoxy(38,14); cout << "ADMIN PROFILE";
// 			}	
// 			if(x==2)
// 			{
// 				H::drawBoxSingleLine(33,17,23,3,130); 
// 				H::setcolor(228); H::gotoxy(42,19); cout << "ADMIN";
  
// 			}
// 			if(x==3)
// 			{
// 				H::drawBoxSingleLine(33,22,23,3,130);
// 				H::setcolor(228); H::gotoxy(42,24); cout << "STAFF";
  
// 			}
// 			if(x==4)
// 			{
// 				H::drawBoxSingleLine(33,27,23,3,130); 
// 				H::setcolor(228); H::gotoxy(42,29); cout << "USER";
  
// 			}
// 			if(x==5)
// 			{
// 				H::drawBoxSingleLine(33,32,23,3,130);
...
// //inside menu left
//   H::drawBoxSingleLine(33,12,23,3,179); H::setcolor(6); H::gotoxy(38,14); cout << "ADMIN PROFILE";
//   H::drawBoxSingleLine(33,17,23,3,179); H::setcolor(6); H::gotoxy(42,19); cout << "ADMIN";
//   H::drawBoxSingleLine(33,22,23,3,179); H::setcolor(6); H::gotoxy(42,24); cout << "STAFF";
//   H::drawBoxSingleLine(33,27,23,3,179); H::setcolor(6); H::gotoxy(42,29); cout << "USER";
//   H::drawBoxSingleLine(33,32,23,3,179); H::setcolor(6); H::gotoxy(42,34); cout << "EXIT";
...
//     H::setcolor(7);H::gotoxy(32,24);MNM("We're the students who received a scholarship from the [1]. Ministry of Post and Telecommunications to study ");
//     H::setcolor(7);H::gotoxy(30,26);MNM("Mobile App(Flutter) Development at [2]. ANT Training Center. Study for 13 Months From 16 June 2025 to 17 July");
//     H::setcolor(7);H::gotoxy(30,28);MNM("2026. Thank to the generous support of the  [1]. Ministry of Post and Telecommunications to study This opportunity");
//     H::setcolor(7);H::gotoxy(30,30);MNM("is allowing us to develop valuable skills in Mobiles App Development and pursue exciting careers intech industry.");
//     H::setcolor(5);H::gotoxy(32,32);cout << "[TIP]  PRESS [1] go to ANT Training Center Website";
//     H::setcolor(5);H::gotoxy(32,34);cout << "       PRESS [2]. go to Ministry of Post and Telecommunications website  [3]. Our Develop Website";
...
void TestMessage()
{
    ...
    while(true)
    {
        a:
        do{
    	H::drawBoxSingleLineWithBG(55,10,70,10,247);
		H::drawBoxSingleLineWithBG(55,10,70,1,145);
		H::foreColor(151);H::gotoxy(58,11);cout << "/_\\ !MESSAGE";
		H::foreColor(241);H::gotoxy(78,16);cout << "INSERTED SUCCESSFULLY!";
        H::setcolor(241);H::gotoxy(68,18);cout << "USE LEFT RIGHT ARR KEY";
		H::drawBoxSingleLineWithBG(57,19,11,1,248);
		H::drawBoxSingleLineWithBG(109,19,14,1,248);
		H::foreColor(244);H::gotoxy(58,20);cout << "[ESC]BACK";
		H::foreColor(244);H::gotoxy(110,20);cout << "[ENTER]AGAIN";

        if(x==1)
        {
            H::drawBoxSingleLineWithBG(57,19,11,1,248);
		    H::foreColor(245);H::gotoxy(58,20);cout << "BACK";
		
        }
        if(x==2)
        {
            H::drawBoxSingleLineWithBG(109,19,14,1,248);
            H::foreColor(245);H::gotoxy(110,20);cout << "AGAIN";
        }
            op1 = getch();
            switch(op1){
                case 75:{
